...
import { readJsonFile, listJsonFiles, getEntitiesDir } from "../utils/file-store.js";
...
export async function resolveContext(
  ...
  if (!result) {
    result = {
      ...
      signal: null,
      ask_user: true,
      reason: "No signal strong enough to resolve context. Ask the user which entity this is.",
      evidence,
      ambiguity,
      candidates: [],
    };
