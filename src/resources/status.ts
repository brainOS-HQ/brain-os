...
export async function generateStatusBrief(): Promise<string> {
  ...
  const lines: string[] = [
    ...
    "═══════════════════════════════════════",
    "",
    "ROUTING RULE: For these questions, call Brain OS tools FIRST — before",
    "reading code, files, or git history:",
    "  focus/priorities/what to work on → focus_get",
    "  project state/blockers/momentum  → entity_read",
